...
view model =
    div [ class "aboutus-container" ]
        ...
        , div [ class "aboutus-row" ]
            [ div [ class "aboutus-icon" ] [ img [ src "./static/images/eye.webp", alt "VISION" ] [] ]
        ...
        , div [ class "aboutus-row" ]
            ...
            , div [ class "aboutus-icon" ] [ img [ src "./static/images/motto.webp", alt "MOTTO" ] [] ]
            ]
        , div [ class "aboutus-row" ]
            [ div [ class "aboutus-icon" ] [ img [ src "./static/images/team.webp", alt "TEAM" ] [] ]
            , div [ class "aboutus-items" ]
